...
public class SaveDiscardableFeedbackCommand implements EmployeeCommand {
        ...
        public SaveDiscardableFeedbackCommand(Connection connection, PrintWriter out, Communicationhandler inputReader,
                        String currentUser) {
        ...
        public void execute() {
                try {
                        ...
                        if (!isValidFeedbackCommand(foodItemId)) {
                                out.println("INVALID_FEEDBACK");
                                return;
                        }
                        out.println("VALID_FEEDBACK");
        ...
        private boolean isValidFeedbackCommand(int foodId) {
                String query = "SELECT COUNT(*) FROM discardablefoodfeedback WHERE foodItemId = ? AND userEmail = ?";
        ...
        private void saveDiscardableFeedback(int foodItemId, String concern, String improvement, String momRecipe)
                        throws SQLException {
