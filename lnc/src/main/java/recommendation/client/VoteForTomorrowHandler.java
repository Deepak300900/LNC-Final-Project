...
public class VoteForTomorrowHandler implements EmployeeCommand {
    ...
    public VoteForTomorrowHandler(BufferedReader in, PrintWriter out, BufferedReader userInput) {
        this.in = in;
        this.out = out;
