...
public class FeedbackForTodayHandler implements EmployeeCommand {
    ...
    public FeedbackForTodayHandler(BufferedReader in, PrintWriter out, BufferedReader userInput) {
        this.in = in;
        this.out = out;
